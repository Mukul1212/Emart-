        ...
        return (
            <>
                <div className="buttons d-flex justify-content-center mb-5 pb-5">
                    ...
                    <button className="btn btn-outline-dark  me-2"onClick={()=>filterProduct("men's clothing")}>Men's chothing</button>
                    <button className="btn btn-outline-dark  me-2"onClick={()=>filterProduct("women's clothing")}>Womens chothing</button> 
        ...
        <div>
            <div className="container my-5 py-5">
                ...
                <div className="row justify-content-center">
                    {loadings ? <Loadings /> : <ShowProducts />}
                </div>
            </div>
        </div>
    );
